...
Holy is that which is of utmost and ultimate importance. If it didn't exists and function properly, nothing would be at all.

1. Tabula Rasa

2. Sex

First, the abscence of preconvieved notions. A clean mind. A clean mind can enter any functional framework. Second, the act of reproduction. Without which, nothing would be at all. If the minds is filled with foreign notions, it will have problems adapting. Sex is fundamental to life. Sexual interventionalism is unholy.
